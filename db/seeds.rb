...
user1 = User.create! :site_admin => true, :email => 'oscar.courchaine@gmail.com', :password => '12345678', :password_confirmation => '12345678', first_name: 'Oscar', last_name: 'Courchaine' ,dj_alias: 'DJ Pamela', id: 100

user2 = User.create! :site_admin => false, :email => 'jochs@brandeis.edu', :password => '12345678', :password_confirmation => '12345678', first_name: 'Jess', last_name: 'Ochs-Willard' ,dj_alias: 'DJ Flashy', id: 101
...
(1..6).each do |index|
	...
	p1 = Playlist.create(title: Faker::Commerce.product_name, user_id: 101)
	(1..6).each do |index|
		r = Random.new
		t = r.rand(150..350)
		p.songs << Song.create(title: Faker::Name.title, album_id: index, artist_id: index, duration: t)
